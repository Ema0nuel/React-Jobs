...
const EditJobPage = ({ updateJobSubmit }) => {
  ...
  const submitForm = (e) => {
    ...
    toast.success("Job Updated Successfully by EMA.");
          ...
          <div className="bg-white px-6 py-8 mb-4 shadow-md rounded-md border m-4 md:m-0">
            <form onSubmit={submitForm}>
              ...
              <div className="mb-4">
                ...
                >
                  <option value="Select Salary">Select Salary</option>
              ...
              <div className="mb-4">
                <label
                  htmlFor="location"
                  className="block textgray-700 font-bold mb-2"
                >
                  Location
                </label>
                <input
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  cols="30"
                  rows="4"
                  placeholder="Add company info and about the company"
